		...
		<div className={classes.root}>
			...
			>
				<div
					...
					style={{ backgroundImage: `url(${logoApp})`, backgroundSize: 'cover' }}
				>
					{/* <h1>E-Report</h1> */}
			...
			<main className={classes.content}>
				...
				<Container maxWidth="lg" className={classes.container}>
					...
					<ProtectedRoute path="/complaint" exact component={Complaint} />
					...
					<ProtectedRoute path="/logs" exact component={Log} />
					{/* </Switch> */}
					<Box pt={4}>
						<Copyright />
					</Box>
